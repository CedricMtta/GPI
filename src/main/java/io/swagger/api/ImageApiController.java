...
public class ImageApiController implements ImageApi {
     ...
     * @return the image modified with status OK if found, status NOT_FOUND otherwise
     */
	 ...
	 * @return a tab of bytes representing the picture with status OK if found, status NOT_FOUND otherwise
	 */
	@Override
	 ...
	 * @param idUtil the id of the user
	 * @param pageable the page for images
